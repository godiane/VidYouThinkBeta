...
$htmlBody .= <<<END
              <ul class="nav flex-column">
                ...
                <li class="nav-item"><a class="nav-link" href="change-pwd.php">Change Password</a></li>
                <li class="nav-item"><a class="nav-link" href="access-controlled.php">Members-Only</a></li>
